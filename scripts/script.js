let weather = {
  ...
  displayWeather: function (data) {
    ...
    console.log(name, icon, temp, description, speed); //Kathmandu 04d 26.02 broken clouds 1.54

    // now displaying this data in page
    ...
    // weather hiding in first display
...
//when search button is slicked
document.querySelector("button").addEventListener("click", (e) => {
  e.preventDefault();
  weather.search();
});
//when enter key is pressed in input search bar
